// Update The Last Node From Circular Linked List Algorithm Implementation In C++
#include<iostream>
using namespace std;
...
class Circularll{
    ...
    // Function to update the node from end position
    void updateAtEnd(int value) {
        if(head != nullptr) { 
            ...
            temp->data=value; // update last node
            return;
        }
    }
